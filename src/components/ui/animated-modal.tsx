      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "min-h-[30%] max-h-[90%] w-full max-w-2xl bg-liberty-base border border-liberty-secondary/30 rounded-2xl relative z-50 flex flex-col overflow-hidden shadow-2xl",
              className
            )}
            initial={{
              opacity: 0,
...
export const ModalFooter = ({
  ...
  return (
    <div
      className={cn(
        "flex justify-end p-4 bg-liberty-secondary/10",
        className
      )}
    >
      {children}
