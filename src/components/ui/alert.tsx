  ...
  "relative w-full rounded-lg border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-1 [&>svg]:text-current",
  {
    variants: {
      variant: {
        ...
        destructive:
          "text-red-700 bg-red-50 border-red-200 [&>svg]:text-current *:data-[slot=alert-description]:text-red-700/90",
        success:
          "text-liberty-primary bg-liberty-primary/5 border-liberty-primary/20 [&>svg]:text-current *:data-[slot=alert-description]:text-liberty-primary/90",
        info:
          "text-liberty-primary bg-liberty-primary/5 border-liberty-primary/20 [&>svg]:text-current *:data-[slot=alert-description]:text-liberty-primary/90",
      },
    },
